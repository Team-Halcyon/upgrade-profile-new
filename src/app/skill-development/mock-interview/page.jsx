...
export default function MockInterviewPage() {
  ...
  const mockFeedback = {
    ...
    improvements: ["Structure responses better", "Be more concise", "Maintain better eye contact"],
  }
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h1 className={`${styles.title} ${animate ? styles.animateTitle : ""}`}>AI-Powered Mock Interview</h1>
        <p className={`${styles.subtitle} ${animate ? styles.animateSubtitle : ""}`}>
          Practice answering common interview questions and receive instant AI feedback
        </p>
      </div>
      ...
      <div className={styles.content}>
        ...
        {feedback && (
          <div className={`${styles.feedbackCard} ${animate ? styles.animateFeedback : ""}`}>
            ...
            <div className={styles.scoreSection}>
              <div className={styles.scoreItem}>
                ...
                <div className={styles.scoreBar}>
                  <div className={styles.scoreProgress} style={{ width: `${feedback.scores.clarity * 100}%` }}></div>
                </div>
                <div className={styles.scoreValue}>{(feedback.scores.clarity * 10).toFixed(1)}</div>
              </div>
              <div className={styles.scoreItem}>
                <div className={styles.scoreLabel}>Relevance</div>
                <div className={styles.scoreBar}>
                  <div className={styles.scoreProgress} style={{ width: `${feedback.scores.relevance * 100}%` }}></div>
                </div>
                <div className={styles.scoreValue}>{(feedback.scores.relevance * 10).toFixed(1)}</div>
              </div>
              <div className={styles.scoreItem}>
                <div className={styles.scoreLabel}>Structure</div>
                <div className={styles.scoreBar}>
                  <div className={styles.scoreProgress} style={{ width: `${feedback.scores.structure * 100}%` }}></div>
                </div>
                <div className={styles.scoreValue}>{(feedback.scores.structure * 10).toFixed(1)}</div>
              </div>
              <div className={`${styles.scoreItem} ${styles.overallScore}`}>
                ...
                <div className={styles.scoreValue}>{(feedback.scores.overall * 10).toFixed(1)}</div>
              </div>
            </div>
      ...
      <div className={`${styles.interviewTips} ${animate ? styles.animateTips : ""}`}>
        ...
        <div className={styles.tipsList}>
          <div className={styles.tipItem}>
            ...
            <div className={styles.tipContent}>
              ...
              <p className={styles.tipText}>
                Structure your answers using Situation, Task, Action, and Result to provide clear and comprehensive
                responses.
              </p>
            </div>
          </div>
          <div className={styles.tipItem}>
            ...
            <div className={styles.tipContent}>
              ...
              <p className={styles.tipText}>
                Use specific examples from your experience rather than general statements.
              </p>
            </div>
          </div>
          <div className={styles.tipItem}>
            ...
            <div className={styles.tipContent}>
              ...
              <p className={styles.tipText}>
                Aim to keep your responses under 2 minutes. Be clear and avoid unnecessary details.
              </p>
            </div>
          </div>
        </div>
